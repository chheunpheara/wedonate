<div>
    <small class="creator"><span class="material-icons inline-icon">person</span> {!! Auth::check() && Auth()->user()->id == $project->user->id ? 'Me' : '<a href="/creator/' . App\Models\User::cryptit($project->user->id) . '">' . $project->user->name . '</a>' !!}</small>
